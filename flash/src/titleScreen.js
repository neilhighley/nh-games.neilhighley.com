...
(lib.titleScreen = function() {
	...
	// Layer 11
	this.instance = new lib.failo_text_small("synched",0);
	this.instance.setTransform(400.8,446,0.57,0.57,0,0,0,107.1,33.2);

	// title
	this.instance_1 = new lib.neilhighley_title("synched",0);
	this.instance_1.setTransform(377.2,234.4,1,1,0,0,0,206.1,119.4);
	...
	this.addChild(this.instance_5,this.instance_4,this.sky,this.footer,this.instance_3,this.instance_2,this.instance_1,this.instance);
...
(lib.failo_text_small = function() {
	...
	// Layer 1
	this.instance = new lib.failo_ball("synched",0);
	this.instance.setTransform(86.6,3,0.257,0.257,0,0,0,35.6,34.9);

	this.instance_1 = new lib.failo_main("synched",0);
